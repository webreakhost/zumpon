                        ...
                        <div className="col-md-6 mb-4 mb-md-0">
                            <figure className="br-sm">
                                <img src="assets/images/pages/become/1.jpg" alt="Banner"
                                    width="610" height="435" style={{backgroundcolor: '#D9D8DD'}} />
                            </figure>
                        </div>
                        <div className="col-md-6 order-md-first">
                            <h4 className="text-primary font-weight-bold ls-25">Create a Store</h4>
                            <h2 className="title text-left">Build your online store on Wolmart</h2>
                            ...
                            <a href="#" className="btn btn-dark btn-outline btn-rounded ls-25">Learn More</a>
                        </div>
                    </div>
                            ...
                            <div className="col-lg-6 mb-4 mb-lg-0">
                                <figure className="br-sm">
                                    <img src="assets/images/pages/become/2.jpg" alt="Banner"
                                        width="610" height="520" style={{backgroundcolor: '#C9C8CD'}} />
                                </figure>
                            </div>
                            <div className="col-lg-6 pl-lg-8">
                                <h4 className="text-primary font-weight-bold ls-25">How to Trade</h4>
